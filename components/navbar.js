    ...
    return (
        ...
        <div class="relative h-14 w-full flex justify-end">
            ...
            <ul id="menu" class="sm:bg-opacity-0 bg-white w-full mr-3 sm:h-full sm:mr-0 sm:flex sm:flex-row flex-col top-16 absolute sm:top-0 hidden">
                <a class="nav-btn sm:ml-auto ml-0 px-5 py-4 border-r border-l border-darkGray text-lightGreen" href="#">About Me</a>
                <a class="nav-btn px-5 py-4 border-r border-l border-darkGray" href="#">Portfolio</a>
                <a class="nav-btn px-5 py-4 border-r border-l border-darkGray" href="#">Contact Me</a>
            </ul>
        </div>`
    );
}
...
(async () => {
    ...
    navBar_$node.innerHTML = await navbar_$func();
